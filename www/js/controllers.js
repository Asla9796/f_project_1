...
.controller('changePassPopupCtrl', ['$scope', 'userDetails',
  ...
  function($scope, userDetails){
    $scope.$watchGroup(['oldPassword', 'newPassword'], function(newValues, oldValues, scope) {
    	var temparray = [];
    	temparray[0] = $scope.oldPassword;
    	temparray[1] = $scope.newPassword;
      userDetails.addChangePassword(temparray);
    }, true);
